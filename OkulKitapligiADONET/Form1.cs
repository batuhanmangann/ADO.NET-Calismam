...
namespace OkulKitapligiADONET
{
    public partial class FormYazarlar : Form
    {
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"{yazar} adlı yazarın Kitaplar tablosunda verileri bulunmaktadır. Bu yazarı silmek için öncelikle sistemdeki ona tanımlı kitapları silmeniz gerekmektedir." +
                    $" Lütfen Kitap işlemleri sayfasına giriniz");
            }
            else
            {
